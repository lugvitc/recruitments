...
// results is true when applications are closed and results are releasedu
      ...
      <section className="h-fit pt-0 relative">
        ...
        <section className=" min-h-screen h-fit flex flex-col justify-center items-center px-4">
          <h1 className="text-5xl uppercase font-mono my-10">
            Why join <br />
            <span className=" italic text-yellow-400 font-semibold">LUG</span>?
          </h1>
          <div className="cardscont max-w-[730px] w-4/5 font-mono">
            <Card className="">
              <h2>Learn & Grow</h2>
              <p>
                Want to learn a new skill? Our club offers guidance from
                experienced members. Join workshops, learn from resources, or
                even teach your own.
              </p>
            </Card>
            <Card className="">
              ...
              <p>
                Where the sharpest minds come together to redefine excellence.
                Push beyond your limits with us.
              </p>
            </Card>
            <Card className="">
        ...
        <section>
          <div className="flex flex-col justify-center items-center h-full">
            <div className="bg-[#0000008e] rounded-md p-4">
              ...
              <p className=" w-80 font-mono">
                LUG empowers FOSS among the student body by fostering innovation
                and collaboration through workshops and events.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className=" min-h-screen h-fit flex flex-col justify-center items-center px-4">
          <h1 className="text-5xl uppercase font-mono my-10">
            <span className=" italic text-yellow-400 font-semibold">FAQ</span>
          </h1>
          <div
            className="cardscont max-w-[350px] w-4/5 font-mono"
            style={{ gridTemplateColumns: "1fr" }}
          >
            <Card className="">
              <h2>Full form of LUG?</h2>
              <p>Linux Users Group</p>
            </Card>
            <Card className="">
            ...
            <Card className="">
              ...
              <p>
                No issues! As long as you're keen to learn, grow, and
                contribute, it doesn't matter what operating system you use.
              </p>
            </Card>
            <Card className="">
