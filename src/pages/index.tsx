			...
			<main>
				<div className="flex flex-col">
					<div className="text-7xl decoration-4 uppercase font-mono">
						We <br/> Are <br/>
						<span className=" italic text-yellow-400">Hiring</span>
					</div>
					<Link to="/apply" className=" rounded-md text-xl mt-4 text-center p-2 bg-yellow-400 text-black uppercase font-semibold hover:bg-black hover:text-white transition-all border border-yellow-400">Apply Now</Link>
				</div>
			</main>
		</section>
		<section className="h-fit pt-0 relative">
			<div className="h-screen sticky top-0 -z-10">
				<div className=" absolute top-0 h-screen w-full bg-transparent"><Background /></div>
			</div>

			<section className="absolute top-0 w-full">
				<div className="flex flex-col justify-center items-center h-full">
					<div className="bg-[#0000008e] rounded-md p-4">
						<h1 className="text-5xl uppercase font-mono">Be a <br /> part of the <br /><span className=" italic text-yellow-400">Best</span></h1>
			...
			<section className=" min-h-screen h-fit flex flex-col justify-center items-center px-4">
					<h1 className="text-5xl uppercase font-mono my-10">Our <br /><span className=" italic text-yellow-400">Departments</span></h1>
					<div className="cardscont max-w-[730px] w-4/5 font-mono">
						<Card className="">
							<h2>Technical</h2>
							<p>
								Empower the club with technology, build solutions, automate tasks,
								ensure cybersecurity and develop applications.
							</p>
						</Card>
						<Card className="">
							<h2>Management</h2>
